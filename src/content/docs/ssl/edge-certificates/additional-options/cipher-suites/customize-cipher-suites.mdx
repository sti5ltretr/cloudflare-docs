...
* If you use Windows you might need to adjust the `curl` syntax, see [Making API calls on Windows](/fundamentals/api/how-to/make-api-calls/#making-api-calls-on-windows).
