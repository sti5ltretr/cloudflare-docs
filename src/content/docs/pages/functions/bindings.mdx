...
To bind your KV namespace to your Pages Function, you can configure a KV namespace binding in the [`wrangler.toml / wrangler.json(c)` file](/pages/functions/wrangler-configuration/#kv-namespaces) or the Cloudflare dashboard.
...
To bind your Durable Object to your Pages Function, you can configure a Durable Object binding in the [`wrangler.toml / wrangler.json(c)` file](/pages/functions/wrangler-configuration/#kv-namespaces) or the Cloudflare dashboard.
...
To bind your R2 bucket to your Pages Function, you can configure a R2 bucket binding in the [`wrangler.toml / wrangler.json(c)` file](/pages/functions/wrangler-configuration/#r2-buckets) or the Cloudflare dashboard.
...
To bind your D1 database to your Pages Function, you can configure a D1 database binding in the [`wrangler.toml / wrangler.json(c)` file](/pages/functions/wrangler-configuration/#d1-databases) or the Cloudflare dashboard.
...
To bind your Vectorize index to your Pages Function, you can configure a Vectorize index binding in the [`wrangler.toml / wrangler.json(c)` file](/pages/functions/wrangler-configuration/#vectorize-indexes) or the Cloudflare dashboard.
...
To bind Workers AI to your Pages Function, you can configure a Workers AI binding in the [`wrangler.toml / wrangler.json(c)` file](/pages/functions/wrangler-configuration/#workers-ai) or the Cloudflare dashboard.
...
To bind your Pages Function to a Worker, configure a Service binding in your Pages Function using the [`wrangler.toml / wrangler.json(c)` file](/pages/functions/wrangler-configuration/#service-bindings) or the Cloudflare dashboard.
...
To bind a queue to your Pages Function, configure a queue producer binding in your Pages Function using the [`wrangler.toml / wrangler.json(c)` file](/pages/functions/wrangler-configuration/#queues-producers) or the Cloudflare dashboard:
...
To bind your Hyperdrive config to your Pages Function, you can configure a Hyperdrive binding in the [`wrangler.toml / wrangler.json(c)` file](/pages/functions/wrangler-configuration/#hyperdrive) or the Cloudflare dashboard.
...
To bind an Analytics Engine dataset to your Pages Function, you must configure an Analytics Engine binding using the [`wrangler.toml / wrangler.json(c)` file](/pages/functions/wrangler-configuration/#analytics-engine-datasets) or the Cloudflare dashboard:
...
To add environment variables to your Pages project, you can use the [`wrangler.toml / wrangler.json(c)` file](/pages/functions/wrangler-configuration/#environment-variables) or the Cloudflare dashboard.
